...
| [H009](H009-stm32c0-c03-metadata-policy-2026-09-12.md) | 2026-09-12 | STM32C0 C0.3 manufacturer-authoritative metadata policy over the retained C0.2 commercial set | Superseded by H010 | Retain as C0.3 history; use H010 for current C0 work |
| [H010](H010-stm32c0-c04-admission-plan-2026-09-12.md) | 2026-09-12 | STM32C0 C0.4 exact-ICPN read-only capability/admission plan | Current / Gate 2 pending | Verify PR #500 final-head CI and current main drift, then Gate 2 merge; do not begin C0.5 without a new Gate 1 |
...
```text
Read repo handover H010 and AGENTS.md, verify PR #500 final-head CI and current main drift, then continue the STM32C0 C0.4 Gate 2 transaction. Do not begin C0.5 without a new Gate 1.
```
