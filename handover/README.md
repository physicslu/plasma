...
| [H011](H011-stm32c0-c05-publication-2026-09-12.md) | 2026-09-12 | STM32C0 C0.5 controlled publication of 209 capability-admittable exact ICPNs | Superseded by H012; PR #503 merged | Retain as C0.5 publication history; use H012 for current STM32 work |
| [H012](H012-stm32-post-c0-evidence-selection-2026-09-12.md) | 2026-09-12 | Post-C0 L1/L0/L4 official-ST evidence comparison and deterministic next-family research selection | Current / Gate 2 pending | Verify PR #504 final-head CI and main drift, then obtain explicit Gate 2 merge approval |
...
```text
Read repo handover H012 and AGENTS.md, verify PR #504 final-head CI and current main drift, then continue the Gate 2 transaction.
```
