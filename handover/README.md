...
| [H010](H010-stm32c0-c04-admission-plan-2026-09-12.md) | 2026-09-12 | STM32C0 C0.4 exact-ICPN read-only capability/admission plan | Superseded by H011 | Retain as C0.4 history; use H011 for current C0 work |
| [H011](H011-stm32c0-c05-publication-2026-09-12.md) | 2026-09-12 | STM32C0 C0.5 controlled publication of 209 capability-admittable exact ICPNs | Current / Gate 2 pending | Verify final PR CI and current main drift, then obtain explicit Gate 2 merge approval |
...
```text
Read repo handover H011 and AGENTS.md, verify the STM32C0 C0.5 PR final-head CI and current main drift, then continue the Gate 2 transaction.
```
