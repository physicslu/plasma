...
- **SWPC public Preview / Mock** — [SWPC Public Preview / Mock Environment](swpc-public-preview.md): `plasma.open4th.com` as the canonical public software-preview ingress, same-origin Mock routing, private engineering-ingress separation, and the explicit boundary that the public hostname is not a Browser-owned Plasma Gateway Endpoint.
