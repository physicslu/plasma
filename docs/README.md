...
- **Current** — [PPU Bootstrap Factory Provisioning and HIL Qualification](deployment/ppu-bootstrap-factory-and-hil.md)：定義 factory/recovery Bootstrap bundle、authenticated Bootstrap service、Console-managed Runtime lifecycle 與 real Z2 HIL proof boundary；real HIL 尚未完成，publisher authenticity、transport confidentiality 與 FPGA update 不得宣稱已 qualification。
