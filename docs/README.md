...
- **Current** — [OpenOCD Compiled-Plan Executor](architecture/ic-support-openocd-plan-executor.md)：以 isolated staging、canonical-plan recompile 與 fake subprocess 驗證 OpenOCD process boundary；production hardware admission 仍維持關閉。
