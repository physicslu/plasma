...
const catalogs: Record<Locale, Catalog> = {
  "zh-TW": {
    ...
    "engineeringProgramming.imageAsset": "Programming Image (.bin)",
    "engineeringProgramming.imageAssetHint": "Program / Verify 共用 · Max 16 MiB",
    "engineeringProgramming.browse": "瀏覽檔案",
  ...
  "en-US": {
    ...
    "engineeringProgramming.browse": "Browse",
