...
const catalogs: Record<Locale, Catalog> = {
  "zh-TW": {
    "nav.entry": "入口", "nav.singlePpu": "單機 PPU", "nav.fleet": "多機 Fleet",
    "mode.label": "工作模式", "mode.production": "量產模式", "mode.engineering": "工程模式",
    ...
    "log.observationNote": "本版顯示 Manager/Fleet observation 與 PPU latest-job 摘要；完整逐階段 programming event log transport 將另行擴充。",
    "log.event.fleetConnected": "Fleet observation connected", "log.event.ppuChanged": "PPU 狀態變更", "log.event.siteChanged": "Site 狀態變更", "log.event.jobObserved": "Job 狀態更新", "log.event.siteResultCleared": "Latched result 已由操作員清除",
    "fleet.connecting": "Connecting", "fleet.online": "Online", "fleet.disabled": "Disabled", "fleet.unavailable": "Unavailable", "fleet.disabledTitle": "Fleet 功能未在此 Host 啟用", "fleet.unavailableTitle": "Fleet snapshot unavailable", "fleet.managerIndependent": "Manager/Fleet 不在本機 Site execution path；單機 PPU 仍可獨立運作。",
  ...
  "en-US": {
    "nav.entry": "Demo", "nav.singlePpu": "Single PPU", "nav.fleet": "Fleet",
    "mode.label": "Work mode", "mode.production": "Production Mode", "mode.engineering": "Engineering Mode",
    "locale.zh": "繁中", "locale.en": "EN",
    "production.title": "Factory Production Console",
    ...
    "log.observationNote": "This version displays Manager/Fleet observations and safe PPU latest-job summaries. Full per-stage programming event-log transport will be added separately.",
    "log.event.fleetConnected": "Fleet observation connected", "log.event.ppuChanged": "PPU state changed", "log.event.siteChanged": "Site state changed", "log.event.jobObserved": "Job state updated", "log.event.siteResultCleared": "Latched result cleared by operator",
    "fleet.connecting": "Connecting", "fleet.online": "Online", "fleet.disabled": "Disabled", "fleet.unavailable": "Unavailable", "fleet.disabledTitle": "Fleet is not enabled on this host", "fleet.unavailableTitle": "Fleet snapshot unavailable", "fleet.managerIndependent": "Manager/Fleet is outside the local Site execution path; single-PPU operation remains independent.",
