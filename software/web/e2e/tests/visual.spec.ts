...
test.describe("visual regression", () => {
  test("idle console", async ({ page }) => {
    ...
    await expectVisual(page, "idle.png");
  });
  ...
  test("batch running", async ({ page }) => {
    ...
    await expectVisual(page, "batch-running.png");
  });
  ...
  test("batch cancelled", async ({ page }) => {
    ...
    await expectVisual(page, "batch-cancelled.png");
  });
  ...
  test("batch failed", async ({ page }) => {
    ...
    await expectVisual(page, "batch-failed.png");
  });
});
