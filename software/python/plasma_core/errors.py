...
class ErrorCode(StrEnum):
    ...
    DUPLICATE_JOB = "E4006"
    BATCH_NOT_FOUND = "E4007"
    BATCH_SITE_FAILURE_THRESHOLD_EXCEEDED = "E4008"
    BATCH_INFRASTRUCTURE_ERROR = "E4009"
    PPU_BUSY = "E4010"
    AUTHENTICATION_REQUIRED = "E4101"
    AUTHORIZATION_DENIED = "E4102"
    COMMAND_REPLAY_CONFLICT = "E4103"
    COMMAND_IN_PROGRESS = "E4104"
...
ERROR_NAMES: dict[ErrorCode, str] = {
    ...
    ErrorCode.BATCH_NOT_FOUND: "BATCH_NOT_FOUND",
    ErrorCode.BATCH_SITE_FAILURE_THRESHOLD_EXCEEDED: "BATCH_SITE_FAILURE_THRESHOLD_EXCEEDED",
    ErrorCode.BATCH_INFRASTRUCTURE_ERROR: "BATCH_INFRASTRUCTURE_ERROR",
    ErrorCode.PPU_BUSY: "PPU_BUSY",
    ErrorCode.AUTHENTICATION_REQUIRED: "AUTHENTICATION_REQUIRED",
    ErrorCode.AUTHORIZATION_DENIED: "AUTHORIZATION_DENIED",
    ErrorCode.COMMAND_REPLAY_CONFLICT: "COMMAND_REPLAY_CONFLICT",
    ErrorCode.COMMAND_IN_PROGRESS: "COMMAND_IN_PROGRESS",
