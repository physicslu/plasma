...
EXPECTED_ICPNS = {
    ...
    "STM32F429NIH6TR": ("STM32F429NI", "2048 KiB", "-40 to 85 C"),
...
def test_phase42z_exact_icpns_are_resolved_by_runtime_catalog() -> None:
...
def test_phase42z_exact_icpns_are_exposed_by_rest_catalog() -> None:
