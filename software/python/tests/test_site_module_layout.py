...
class SiteModuleLayoutTests(unittest.TestCase):
    def test_canonical_site_modules_own_implementation_without_retired_facades(self) -> None:
        ...
        self.assertFalse((server_dir / "channel_manager.py").exists())
        self.assertFalse((server_dir / "channel_worker.py").exists())
