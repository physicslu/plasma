...
The factory Bootstrap deals in one product deployment artifact:
``plasma-z2-ps-kit-<release-id>.tar.gz``. It verifies outer and inner integrity,
then delegates installation to the kit-local ``plasmactl z2-ps`` tooling.
