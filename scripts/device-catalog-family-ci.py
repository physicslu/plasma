...
def command_profile(family: str) -> list[list[str]]:
    profiles: dict[str, list[list[str]]] = {
        ...
        "stm32u0": [
            ...
            _py("data/device-catalog/research/test_stm32u0_phase_u0_2_discovery.py"),
            _py("data/device-catalog/research/validate_stm32u0_phase_u0_2_retained_evidence.py"),
            _py("data/device-catalog/research/test_stm32u0_phase_u0_3_policy.py"),
        ...
        "stm32c0": [
            ...
            _py("data/device-catalog/research/test_stm32c0_phase_c0_3_policy.py"),
