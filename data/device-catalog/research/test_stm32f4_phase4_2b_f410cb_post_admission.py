...
EVIDENCE = HERE / "evidence" / "stm32f4-phase4.2b-f410cb-admission-live-2026-09-02"
BASELINE = HERE / "stm32f4-phase4.2b-f410cb-admission-baseline.json"
CATALOG = HERE / "openocd-parts-canonical.csv"
CANONICAL = HERE / "stm32f4-commercial-icpn.csv"
PRODUCTION_MANIFEST = HERE.parent / "production" / "icpn-v1-manifest.json"
AUDIT = HERE / "stm32f4-phase4.2b-f410cb-admission-audit.json"
NEW_BASES = {"STM32F410CB"}
EXPECTED_EVIDENCE_ID = "stm32f4-phase4.2b-f410cb-admission-2026-09-02-retained-20260902T030605Z-664109b"
EXPECTED_PLAN_SHA256 = "b10adc356811557a2c80f453ade374a5ffd85cbb283f3c3b6455801687eda183"
EXPECTED_CANONICAL_SHA256 = "c4e3889392383cb7861bb29c759074c5089a47ae518a1a8cb5330af97335c7f4"
EXPECTED_CANONICAL_GIT_BLOB = "c77df45c0cd8c03c71090df04176da5371d57124"
EXPECTED_NEW_ICPNS = {
    "STM32F410CBT3",
    "STM32F410CBT6",
    "STM32F410CBU3",
...
PRE_PHASE42B_EVIDENCE_IDS = {
    ...
    "stm32f4-phase4.1-rt-admission-batch4-2026-09-02-retained-20260902T005937Z-f2c2198",
}
...
class Phase42BF410CBPostAdmissionTests(unittest.TestCase):
    def _prewrite(self, output: Path) -> None:
        with CANONICAL.open(newline="", encoding="utf-8") as handle:
            reader = csv.DictReader(handle)
            fields = list(reader.fieldnames or [])
            rows = [row for row in reader if _evidence_id(row) in PRE_PHASE42B_EVIDENCE_IDS]
    ...
    def test_retained_evidence_and_audit(self) -> None:
        ...
        self.assertEqual(audit["evidence_artifact_id"], "9830008020")
        self.assertEqual(audit["proposal_workflow_run_id"], "33586071276")
        self.assertEqual(audit["proposal_artifact_id"], "9830104671")
        self.assertEqual(audit["pre_rows"], 194)
        self.assertEqual(audit["post_rows"], 199)
        self.assertEqual(audit["new_exact_icpns"], 5)
        self.assertEqual(audit["decision_counts"], {"admit": 5, "already_present": 0, "manual_review_required": 0, "reject": 0})
        ...
        self.assertEqual(set(audit["added"]), EXPECTED_NEW_ICPNS)
        self.assertEqual(audit["excluded_non_active"], [])

    def test_current_replan_is_already_present(self) -> None:
        ...
        self.assertEqual(plan["decision_counts"], {"admit": 0, "already_present": 5, "manual_review_required": 0, "reject": 0})

    def test_historical_replay_194_to_199_is_byte_identical(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertEqual((result["rows_before"], result["rows_after"], len(result["added"])), (194, 199, 5))
    ...
    def test_current_manifest_and_inventory_are_growth_safe(self) -> None:
