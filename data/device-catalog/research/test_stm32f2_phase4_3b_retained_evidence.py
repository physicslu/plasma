...
def main() -> int:
    ...
    assert report["active_exact_icpn_candidates"] == 9
    assert report["excluded_non_active_part_numbers"] == 0
    assert report["unique_openocd_mappings"] == 9
    ...
    with tempfile.TemporaryDirectory() as temporary_directory:
        ...
        summary["results"][0]["evidence"]["exact_icpns"].append("STM32F205RBT8")
    ...
    print("Phase 4.3B STM32F2 retained evidence PASS")
    return 0
