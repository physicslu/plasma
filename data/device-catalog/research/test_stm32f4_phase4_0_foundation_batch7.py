...
MANIFEST = HERE / "stm32f4-phase4.0-foundation-batch7-manifest.json"
EVIDENCE = HERE / "evidence" / "stm32f4-phase4.0-foundation-batch7-live-2026-08-31"
CATALOG = HERE / "openocd-parts-canonical.csv"
CANONICAL = HERE / "stm32f4-commercial-icpn.csv"
CONTROL_BASE = "STM32F439VG"
NEW_BASES = {"STM32F439ZG", "STM32F439ZI"}
EXPECTED_NEW_ICPNS = 7
EXPECTED_EVIDENCE_ID = "stm32f4-phase4.0-foundation-batch7-2026-08-31-retained-20260831T080025Z-feef382"


class STM32F4Phase40FoundationBatch7Tests(unittest.TestCase):
    ...
    def test_baseline_is_discovery_locked_active_only_and_denies_admission(self) -> None:
        ...
        self.assertEqual(
            baseline["pilot_id"],
            "stm32f4-phase4.0-foundation-batch7-2026-08-31",
        )
        self.assertFalse(baseline["canonical_dataset_admission"])
        self.assertEqual(baseline["source_workflow_run_id"], "33370308307")
        self.assertEqual(baseline["source_artifact_id"], "9749799501")
    ...
    def test_all_7_new_exact_icpns_have_unique_ordering_pattern_mapping(self) -> None:
    ...
    def test_existing_policy_builds_expected_batch7_rows(self) -> None:
        catalog_rows = self._catalog_rows()
        fields = self._canonical_fields()
        cases = {
            "STM32F439ZGT7TR": ("STM32F439ZG", "LQFP", "144", "1024 KiB"),
            "STM32F439ZGY6TR": ("STM32F439ZG", "WLCSP", "143", "1024 KiB"),
            "STM32F439ZIT6": ("STM32F439ZI", "LQFP", "144", "2048 KiB"),
            "STM32F439ZIY6TR": ("STM32F439ZI", "WLCSP", "143", "2048 KiB"),
        }
            ...
            with self.subTest(icpn=icpn):
                candidate = {
                    ...
                    "authoritative_evidence": {
                        "evidence_id": "phase4.0-foundation-batch7-policy-contract",
                        "source_url": (
