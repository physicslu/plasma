...
class STM32L0L02DiscoveryTests(unittest.TestCase):
    @classmethod
    ...
    def test_deterministic_targets_are_complete_bounded_unique_surface(self) -> None:
        ...
        self.assertGreater(len(bases), 16)
        self.assertLessEqual(len(bases), 164)
        ...
        self.assertTrue(EXPECTED_L0_1_REPRESENTATIVES.issubset(set(bases)))
    ...
    def test_target_manifest_is_research_only_and_deterministic(self) -> None:
        ...
        self.assertEqual(first["phase"], "L0.2")
        self.assertEqual(first["family"], "STM32L0")
    ...
    def test_lifecycle_only_nonrepresentative_target_can_be_cleanly_dispositioned(self) -> None:
        lifecycle_base = next(
            ...
            if target.base_device not in EXPECTED_L0_1_REPRESENTATIVES
        )
    ...
    def test_representative_lifecycle_regression_blocks_continuity(self) -> None:
        lifecycle_base = sorted(EXPECTED_L0_1_REPRESENTATIVES)[0]
