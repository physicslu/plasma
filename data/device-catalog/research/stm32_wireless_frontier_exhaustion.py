...
def render()->dict[str,Any]:
    ...
    prior=load(PRIOR); g5=load(WBA5_GATE); g6=load(WBA6_GATE); prod=load(PRESTATE)
    ...
    req(isinstance(eligible,list) and len(eligible)==1 and eligible[0].get("plasma_series")=="STM32WBA5X","prior eligible surface drifted")
    req(g5.get("decision")=="defer_frontier_pending_official_product_evidence" and g5.get("catalog_admission_ready") is False,"WBA5X block drifted")
    req(g6.get("decision")=="defer_frontier_pending_official_product_evidence" and g6.get("catalog_admission_ready") is False,"WBA6X block drifted")
    wba5={**eligible[0],
      "defer_reasons":["official_st_evidence_incomplete","stm32wba50ke_product_page_http_404"],
      "evidence_gate":g5["gate_id"],"evidence_gate_decision":g5["decision"]}
    deferred=[*prior["deferred_wireless_frontiers"],wba5]
    return {
      ...
      "upstream": {
            ...
            "wba5x_evidence_gate_git_blob_sha": EXPECTED_WBA5_GATE_BLOB,
            ...
            "wba6x_evidence_gate_git_blob_sha": EXPECTED_WBA6_GATE_BLOB,
