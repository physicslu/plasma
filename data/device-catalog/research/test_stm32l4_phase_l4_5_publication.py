#!/usr/bin/env python3
"""Post-publication hard-lock regressions for STM32L4 L4.5."""
...
class STM32L4PhaseL45PublicationTests(unittest.TestCase):
    @classmethod
    ...
    def test_canonical_rows_retain_l4_admission_semantics(self) -> None:
    ...
    def test_production_manifest_has_one_bound_l4_source(self) -> None:
