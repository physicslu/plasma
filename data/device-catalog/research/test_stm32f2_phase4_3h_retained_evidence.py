...
from validate_stm32f2_phase4_3h_retained_evidence import (
    DEFAULT_BASELINE,
...
def main() -> int:
    ...
    assert report["active_exact_icpn_candidates"] == 11
    assert report["excluded_non_active_part_numbers"] == 0
    assert report["unique_openocd_mappings"] == 11
    ...
    with tempfile.TemporaryDirectory() as temporary_directory:
        ...
        summary["results"][0]["evidence"]["exact_icpns"].append("STM32F205RET8")
    ...
    print("Phase 4.3H STM32F2 retained evidence PASS")
    return 0
