#!/usr/bin/env python3
"""Bounded official-ST evidence accessibility probe for STM32WBA5X.
...
PROBE_ID = "stm32wba5x-bounded-official-st-evidence-accessibility-v1"
...
def deterministic_targets() -> list[ProbeTarget]:
    ...
    expected_bases = ("STM32WBA50KE", "STM32WBA52CE", "STM32WBA54CE", "STM32WBA55CE", "STM32WBA5MMG")
...
def run_live(
    ...
    *,
    ...
    summary = {
        "schema_version": 1,
        "probe_id": PROBE_ID,
        "scope": "STM32WBA5X bounded representative official-ST commercial identity/lifecycle evidence accessibility",
