#!/usr/bin/env python3
"""Run STM32G4 Phase 4.9B with the family-owned dual-surface browser profile."""
from __future__ import annotations
import argparse, json
from importlib.metadata import PackageNotFoundError, version
from pathlib import Path
from stm32g4_browser_acquisition import STM32G4BrowserAcquirer
from stm32g4_dual_surface_evidence import PARSER_PROFILE, build_dual_surface_browser_evidence_record
...
def main(argv: list[str] | None = None) -> int:
    ...
    with STM32G4BrowserAcquirer(base_by_url=base_by_url, headless=a.headless) as acq:
