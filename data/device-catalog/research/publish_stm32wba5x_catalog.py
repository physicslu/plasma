#!/usr/bin/env python3
"""Render STM32WBA5X Production catalog publication."""
...
READINESS = HERE / "stm32wba5x-admission-readiness.json"
CANONICAL = HERE / "stm32wba5x-commercial-icpn.csv"
...
EXPECTED_ROWS = 40
EXPECTED_BASES = 15
EXPECTED_PRESTATE_EXACT = 2604
EXPECTED_POSTSTATE_EXACT = 2644
EXPECTED_PRESTATE_FAMILIES = 21
EXPECTED_POSTSTATE_FAMILIES = 22
EXPECTED_CANONICAL_SHA256 = "653dca4184eab05c3a0c8e6714e73adacf3d6927310855faf064b7d8d0b322d6"
EXPECTED_CANONICAL_GIT_BLOB_SHA = "21cd808371f4d6f05a813e35b06cb1227f96195a"
EXPECTED_READINESS_GIT_BLOB_SHA = "ae1fa1399f9260c7d90005cb38c7dac6fa4c58e9"
EXPECTED_EXACT_SET_SHA256 = "de7b479493688ad5ac4417682f384da64af391850e876b45a649823fbe395485"
EXPECTED_PRESTATE_MANIFEST_GIT_BLOB_SHA = "6e0fc69bec067259a1c52e150a313591cf4523e8"
...
def validate_readiness() -> None:
    ...
    r=json.loads(data)
    req(r.get("readiness_id")=="stm32wba5x-bounded-exact-icpn-admission-readiness-v1","readiness id drifted")
    req(r.get("catalog_admission_ready") is True,"catalog admission is not ready")
    req(r.get("next_gate")=="stm32wba5x-production-publication-gate","publication gate drifted")
    ...
    req(r.get("route_assignment_kind_counts")=={"ordering_pattern":40},"route assignment drifted")
    req(r.get("mapping_status_counts")=={"deterministic_ordering_pattern":40},"mapping status drifted")
...
def render() -> tuple[dict[str,Any],dict[str,Any]]:
    ...
    proposal={
      "schema_version":1,
      "transaction":"stm32wba5x-production-catalog-publication",
      "status":"publication_ready",
      "manufacturer":MANUFACTURER,
      "research_series":SERIES,
      "family":FAMILY,
      "readiness_baseline":"stm32wba5x-admission-readiness.json",
      ...
      "route_assignment_kind_counts":{"ordering_pattern":40},
      "mapping_status_counts":{"deterministic_ordering_pattern":40},
