...
AUDIT = HERE / "stm32f4-phase4.0-f446-batch1-admission-audit.json"
NEW_BASES = {"STM32F446VC", "STM32F446VE", "STM32F446ZC", "STM32F446ZE"}
EXPECTED_CANONICAL_SHA256 = "9ccab9f4de5c447410b2d649ce933fddcc569746431bf9cb0431fa8246676308"
...
class STM32F4Phase40F446PostAdmissionTests(unittest.TestCase):
    ...
    def test_materialization_replays_49_to_72_and_is_byte_identical(self) -> None:
        new_icpns = set(self._audit()["icpns"])
        self.assertEqual(len(new_icpns), 23)
