...
MANIFEST = HERE / "stm32f4-phase4.0-foundation-batch2-manifest.json"
...
class STM32F4Phase40FoundationBatch2Tests(unittest.TestCase):
    ...
    def test_baseline_is_discovery_locked_and_active_only(self) -> None:
        ...
        self.assertEqual(
            baseline["pilot_id"],
            "stm32f4-phase4.0-foundation-batch2-2026-08-31",
        )
        ...
        self.assertEqual(
            excluded,
            {
                ("STM32F401CC", "STM32F401CCF6TR", "Preview"),
                ("STM32F405VG", "STM32F405VGT6V", "NRND"),
                ("STM32F405VG", "STM32F405VGT6W", "NRND"),
                ("STM32F405ZG", "STM32F405ZGT6V", "NRND"),
                ("STM32F405ZG", "STM32F405ZGT6W", "NRND"),
            },
        )
    ...
    def test_existing_policy_builds_expected_lqfp_1mib_rows(self) -> None:
        catalog_rows = self._catalog_rows()
        fields = self._canonical_fields()
        cases = {
            "STM32F405VGT6": ("STM32F405VG", "LQFP", "100", "1024 KiB"),
            "STM32F405ZGT7TR": ("STM32F405ZG", "LQFP", "144", "1024 KiB"),
            "STM32F415ZGT6": ("STM32F415ZG", "LQFP", "144", "1024 KiB"),
            "STM32F417VGT7": ("STM32F417VG", "LQFP", "100", "1024 KiB"),
            "STM32F417ZGT6": ("STM32F417ZG", "LQFP", "144", "1024 KiB"),
        }
            ...
            with self.subTest(icpn=icpn):
                candidate = {
                    ...
                    "authoritative_evidence": {
                        "evidence_id": "phase4.0-foundation-batch2-policy-contract",
                        "source_url": (
