...
<html>
  <body>
    ...
    <table>
      <thead><tr><th>Part Number</th><th>Grade</th></tr></thead>
      <tbody>
        <tr><td>STM32F103C8T6</td><td>Industrial</td></tr>
        <tr><td>STM32F103C8T6TR</td><td>Industrial</td></tr>
        <tr><td>STM32F103C8T7</td><td>Industrial</td></tr>
        <tr><td>STM32F103C8T7TR</td><td>Industrial</td></tr>
      </tbody>
    </table>
...
class ProductPageAcquisitionTests(unittest.TestCase):
    def test_extracts_unique_exact_icpns_from_quality_section(self) -> None:
    ...
    def test_missing_part_number_marker_fails_closed(self) -> None:
        html = "<h2>Quality and Reliability</h2><p>STM32F103C8T6</p><h2>Next</h2>"
    ...
    def test_foreign_stm32_token_in_evidence_section_fails_closed(self) -> None:
        html = """
        <h2>Quality and Reliability</h2>
        <p>Part Number STM32F103C8T6 STM32F103CBT6</p>
        <h2>Next</h2>
        """
