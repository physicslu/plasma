#!/usr/bin/env python3
"""Run STM32L1 L1.2 generation-aware manufacturer-authoritative discovery."""
...
def build_browser_acquirer(*, base_by_url: dict[str, str], headless: bool) -> STDualSurfaceBrowserAcquirer:
...
def main(argv: list[str] | None = None) -> int:
    ...
    with build_browser_acquirer(base_by_url=base_by_url, headless=args.headless) as acquirer:
