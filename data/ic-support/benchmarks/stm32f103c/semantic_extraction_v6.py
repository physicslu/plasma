...
SEMANTIC_SCHEMA = HERE / "semantic-extraction-v4.schema.json"
PROMPT_TEMPLATE = HERE / "semantic-extraction-prompt-v4.txt"
SEMANTIC_EXPERIMENT_ID = "stm32f103c-semantic-extraction-v4"
SEMANTIC_RUN_SCHEMA_VERSION = "0.5.0"
