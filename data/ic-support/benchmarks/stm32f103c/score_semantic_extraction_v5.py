...
GROUND_TRUTH = HERE / "semantic-extraction-ground-truth-v3.json"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Score one STM32F103C v5 semantic extraction run")
    ...
    try:
        ...
        print("IC v5 semantic extraction scoring COMPLETE")
        ...
        print(f"IC v5 semantic extraction scoring FAIL: {exc}", file=sys.stderr)
        return 1
