...
GROUND_TRUTH = HERE / "canonical-ground-truth-v7.json"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Score one canonicalized STM32F103C v9 semantic extraction run")
    ...
    try:
        ...
        print("IC canonical v9 scoring COMPLETE")
        ...
        print(f"IC canonical v9 scoring FAIL: {exc}", file=sys.stderr)
        return 1
