...
PIPELINE_ID = "stm32f103c-programming-option-memory-package-relationship-derived-semantic-to-canonical-v5"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Canonicalize one retained STM32F103C v7 semantic extraction run")
    ...
    try:
        ...
        print("IC v7 semantic run canonicalization COMPLETE")
        ...
        print(f"IC v7 semantic run canonicalization FAIL: {exc}", file=sys.stderr)
        return 1
