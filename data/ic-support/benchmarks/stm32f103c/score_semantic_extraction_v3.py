...
GROUND_TRUTH = HERE / "semantic-extraction-ground-truth-v1.json"
...
def score_run(run: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "trust_boundary": {
            ...
            "free_form_option_semantic_equivalence": False,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Score one STM32F103C structured semantic extraction run")
    ...
    try:
        ...
        print("IC structured semantic extraction scoring COMPLETE")
        ...
        print(f"IC structured semantic extraction scoring FAIL: {exc}", file=sys.stderr)
        return 1
