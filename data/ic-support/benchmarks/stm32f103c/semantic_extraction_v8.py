...
SEMANTIC_SCHEMA = HERE / "semantic-extraction-v6.schema.json"
PROMPT_TEMPLATE = HERE / "semantic-extraction-prompt-v6.txt"
SEMANTIC_EXPERIMENT_ID = "stm32f103c-semantic-extraction-v6"
SEMANTIC_RUN_SCHEMA_VERSION = "0.7.0"
