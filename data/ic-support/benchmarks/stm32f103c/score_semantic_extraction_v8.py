...
GROUND_TRUTH = HERE / "semantic-extraction-ground-truth-v6.json"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Score one STM32F103C v8 semantic extraction run")
    ...
    try:
        ...
        print("IC v8 semantic extraction scoring COMPLETE")
        ...
        print(f"IC v8 semantic extraction scoring FAIL: {exc}", file=sys.stderr)
        return 1
