...
SEMANTIC_SCHEMA = HERE / "semantic-extraction-v1.schema.json"
PROMPT_TEMPLATE = HERE / "semantic-extraction-prompt-v1.txt"
SEMANTIC_EXPERIMENT_ID = "stm32f103c-semantic-extraction-v1"
SEMANTIC_RUN_SCHEMA_VERSION = "0.2.0"
