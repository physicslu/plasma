...
PIPELINE_ID = "stm32f103c-structured-semantic-to-canonical-v1"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Canonicalize one retained STM32F103C structured semantic extraction run")
    ...
    try:
        ...
        print("IC structured semantic run canonicalization COMPLETE")
        ...
        print(f"IC structured semantic run canonicalization FAIL: {exc}", file=sys.stderr)
        return 1
