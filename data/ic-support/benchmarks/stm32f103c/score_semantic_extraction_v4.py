...
GROUND_TRUTH = HERE / "semantic-extraction-ground-truth-v2.json"
...
def score_run(run: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "trust_boundary": {
            ...
            "debug_interface_order_is_semantically_significant": False,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Score one STM32F103C relationship-derivation semantic extraction run")
    ...
    try:
        ...
        print("IC relationship-derivation semantic extraction scoring COMPLETE")
        ...
        print(f"IC relationship-derivation semantic extraction scoring FAIL: {exc}", file=sys.stderr)
        return 1
