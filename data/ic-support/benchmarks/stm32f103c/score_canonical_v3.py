...
GROUND_TRUTH = HERE / "canonical-ground-truth-v1.json"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Score one canonicalized STM32F103C structured semantic extraction run")
    ...
    try:
        ...
        print("IC canonical v3 scoring COMPLETE")
        ...
        print(f"IC canonical v3 scoring FAIL: {exc}", file=sys.stderr)
        return 1
