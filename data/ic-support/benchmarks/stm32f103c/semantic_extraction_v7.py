...
SEMANTIC_SCHEMA = HERE / "semantic-extraction-v5.schema.json"
PROMPT_TEMPLATE = HERE / "semantic-extraction-prompt-v5.txt"
SEMANTIC_EXPERIMENT_ID = "stm32f103c-semantic-extraction-v5"
SEMANTIC_RUN_SCHEMA_VERSION = "0.6.0"
