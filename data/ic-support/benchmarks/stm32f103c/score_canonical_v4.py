...
GROUND_TRUTH = HERE / "canonical-ground-truth-v2.json"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Score one canonicalized STM32F103C relationship-derived semantic extraction run")
    ...
    try:
        ...
        print("IC canonical v4 scoring COMPLETE")
        ...
        print(f"IC canonical v4 scoring FAIL: {exc}", file=sys.stderr)
        return 1
