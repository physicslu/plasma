...
PIPELINE_ID = "stm32f103c-programming-memory-package-relationship-derived-semantic-to-canonical-v4"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Canonicalize one retained STM32F103C v6 semantic extraction run")
    ...
    try:
        ...
        print("IC v6 semantic run canonicalization COMPLETE")
        ...
        print(f"IC v6 semantic run canonicalization FAIL: {exc}", file=sys.stderr)
        return 1
