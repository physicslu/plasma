...
GROUND_TRUTH = HERE / "canonical-ground-truth-v5.json"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Score one canonicalized STM32F103C v7 semantic extraction run")
    ...
    try:
        ...
        print("IC canonical v7 scoring COMPLETE")
        ...
        print(f"IC canonical v7 scoring FAIL: {exc}", file=sys.stderr)
        return 1
