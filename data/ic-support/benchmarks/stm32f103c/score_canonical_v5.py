...
GROUND_TRUTH = HERE / "canonical-ground-truth-v3.json"
SCORE_SCHEMA_VERSION = "0.4.0"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Score one canonicalized STM32F103C v5 run")
    ...
    try:
        ...
        print("IC canonical v5 scoring COMPLETE")
        ...
        print(f"IC canonical v5 scoring FAIL: {exc}", file=sys.stderr)
        return 1
