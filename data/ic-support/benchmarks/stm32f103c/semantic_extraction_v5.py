...
SEMANTIC_SCHEMA = HERE / "semantic-extraction-v3.schema.json"
PROMPT_TEMPLATE = HERE / "semantic-extraction-prompt-v3.txt"
SEMANTIC_EXPERIMENT_ID = "stm32f103c-semantic-extraction-v3"
SEMANTIC_RUN_SCHEMA_VERSION = "0.4.0"
