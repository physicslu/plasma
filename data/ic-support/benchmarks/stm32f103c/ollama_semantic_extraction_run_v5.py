...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run one STM32F103C v5 semantic extraction through bounded Ollama native chat"
    )
    ...
    try:
        ...
        print(
            f"Ollama v5 semantic extraction {record['status']}: arm={args.arm}; "
        ...
        print(f"Ollama v5 semantic extraction FAIL: {exc}", file=sys.stderr)
        return 1
